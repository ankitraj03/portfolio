...
function About() {
  ...
  const techList2 = ["MongoDB", "C++", "ExpressJS"];
  ...
  return (
    <div className="mt-10 px-4 sm:px-8 md:px-16">
      ...
      <div className="text-gray-400 text-lg sm:text-xl font-mono mt-5 leading-7">
        Hello! My name is Ankit, and I am a passionate web developer with a keen interest in creating seamless and intuitive user experiences on the web. My expertise lies in frontend development, where I leverage modern technologies to craft responsive and visually appealing websites.
        <br />
        <br />
        In addition to building projects, I enjoy solving challenging problems on platforms like LeetCode and GeeksforGeeks, where I have solved over <span className="text-[#07eafa]">400+ problems</span> on these and other coding platforms, sharpening my skills in data structures and algorithms.
        <br />
        <br />
